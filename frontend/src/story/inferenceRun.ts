...
export const INFERENCE_RUN: InferenceChapter[] = [
	...
	{ index: 1, title: "Fine-Tuning", rounds: 3, requiredPercent: 60 },
	{ index: 2, title: "Decoding", rounds: 3, requiredPercent: 75 },
	{ index: 3, title: "Alignment", rounds: 2, requiredPercent: 90 },
	{ index: 4, title: "Singularity", rounds: 1, requiredPercent: 100 },
];
